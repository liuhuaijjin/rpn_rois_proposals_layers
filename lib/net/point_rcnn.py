        ...
        if cfg.RPN.ENABLED:
            ...
            if cfg.RCNN.ENABLED:
                with torch.no_grad():
                    ...
                    # proposal layer
                    rois, roi_scores_raw = self.rpn.proposal_layer(rpn_scores_raw, rpn_reg, backbone_xyz,input_data)  #(B, 512, 7) (B, 512)
                    rois1,roi_scores_raw1 = self.rpn.proposal_layer1(rpn_scores_raw, rpn_reg, backbone_xyz,input_data)
                    output['rois'] = rois
